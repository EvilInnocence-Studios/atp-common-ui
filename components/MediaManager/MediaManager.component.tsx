...
export const MediaManagerComponent = overridable(({ images, isLoading, upload, overwrite, setOverwrite, refresh, query, setQuery, classes = styles }: MediaManagerProps) =>
    <Spin spinning={isLoading}>
        <Row className={classes.mediaManager} gutter={16}>
            <Col xs={3}>
            ...
            <Col xs={24}>
                ...
                <Row gutter={16} className={classes.mediaList}>
